...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void cadastrar() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro! Não foi possível cadastrar, TENTE NOVAMENTE! ");
        }   
    }
    ...
    private boolean verificarCampos(){
        ...
        if(cadastroNome.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(null, "Preenchar o campo VALOR para cadastrar");
            return true;
        }else if(!cadastroValor.getText().matches("\\d+")) {
            JOptionPane.showMessageDialog(null, "O campo VALOR deve conter apenas números (inteiros)");
            return true; // Indica que há problemas nos campos.
        }
        return false;
    }
}
